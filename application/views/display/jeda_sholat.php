...
<body>
    <main>
        <div id="left-container">
            ...
            <div id="tampilan-jadwal" style="margin: 24vh 0 0px 0vh; font-size: 12vw;
">JEDA <br> SHOLAT
            </div>
    ...
    <script>
        ...
        function cek_jadwal_sholat() {
            $.ajax({
                url: "<?= base_url("cek-jadwal-sholat-jeda") ?>",
                type: "get",
        ...
        // Perbaikan di sini: setInterval harus menerima referensi fungsi, bukan hasil eksekusi fungsi
        setInterval(cek_jadwal_sholat, 1000);
