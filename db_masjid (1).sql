...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Sep 2023 pada 08.54
...
--
-- Struktur dari tabel `t_video_display`
--

CREATE TABLE `t_video_display` (
  `id_video_display` varchar(50) NOT NULL,
  `nama_file` text NOT NULL,
  `date_g` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `t_video_display`
--

INSERT INTO `t_video_display` (`id_video_display`, `nama_file`, `date_g`) VALUES
('1', 'y2mate_com_-_Dokter_RSB_Sartika_Asih_pada_event_Family_Gathering_Komite_Medik_Goes_to_Nara_Park_360p.mp4', '2023-09-14 06:52:12');
...
--
-- Indeks untuk tabel `t_video_display`
--
ALTER TABLE `t_video_display`
  ADD PRIMARY KEY (`id_video_display`);
